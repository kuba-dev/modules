...
namespace KubaDev\Modules\Console\Commands;

use Illuminate\Console\Command;
use Illuminate\Console\ConfirmableTrait;
use KubaDev\Modules\RepositoryManager;
use Illuminate\Database\Migrations\Migrator;
use KubaDev\Modules\Traits\MigrationTrait;
use KubaDev\Modules\Repositories\Repository;
...
class ModuleMigrateRollbackCommand extends Command
{
     ...
     *
     * @param \KubaDev\Modules\Repositories\Repository $repository
     *
     * @return array
     */
