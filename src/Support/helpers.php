...
use KubaDev\Modules\Exceptions\ModuleNotFoundException;
...
if (!function_exists('modules')) {
     ...
     * @return \KubaDev\Modules\RepositoryManager|\KubaDev\Modules\Repositories\Repository
     */
...
if (!function_exists('module_path')) {
     ...
     * @return string
     * @throws \KubaDev\Modules\Exceptions\ModuleNotFoundException
     */
